...
<p align="center">
  ...
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/sanderdsz/gymaster?color=%2304D361">

  <img alt="Frontend" src="https://img.shields.io/badge/web-html-red">
...
The <strong>Gymaster</strong> is a web simple crud made to be minimalistic and with pure html and css.
...
```sh
  $ git clone https://github.com/sanderdsz/gymaster.git
```
